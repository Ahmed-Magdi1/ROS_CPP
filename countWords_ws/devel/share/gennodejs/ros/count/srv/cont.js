...
class contRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type contRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type contRequest
    let len;
    let data = new contRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new contRequest(null);
...
class contResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type contResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type contResponse
    let len;
    let data = new contResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new contResponse(null);
